...
all_regularizers = ["N3", "F2", "DURA_W", "Or_Regu","Or_Regu_double","Or_Regu_F2",
"DURA_RESCAL", "DURA_RESCAL_H","DURA_ComplexH", "DURA_DistMultH", "DURA_RESCAL_W", 
"DURA_RESCAL_P", "DURA_DistMultH_P","DURA_RESCAL_1","DURA_RESCAL_2", "DURA_DualH"]
...
class DURA_DualH(Regularizer):
    def __init__(self, weight: float):
        super(DURA_DualH, self).__init__()
        self.weight = weight
    ...
    def forward(self, factors):
        ...
        norm += 0.5 * torch.sum(t**2 + h**2)
        res1 = given_8_rotation(r, h)
        res2 = given_8_rotation_T(r, t)
        norm += 1.5 * torch.sum(res1**2 + res2**2)
