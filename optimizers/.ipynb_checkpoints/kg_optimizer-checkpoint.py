...
class KGOptimizer(object):
    ...
    def __init__(
            self, model, regularizer, optimizer, batch_size, neg_sample_size, double_neg, verbose=True, smoothing=0.0, weight=None):
        """Inits KGOptimizer."""
        self.model = model
        ...
        # self.loss_fn = LabelSmoothLoss(smoothing = smoothing)
